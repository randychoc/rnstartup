...
const carePlans = [
  {
    ...
    price: "Q350",
    period: "/mes",
    target: "Tu sitio siempre en línea, sin que pienses en él",
    highlighted: false,
    features: [
  ...
  },
  {
    ...
    price: "Q650",
    period: "/mes",
    target: "Tu presencia digital siempre al día",
    highlighted: true,
    features: [
  ...
  },
  {
    ...
    price: "Q1,200",
    period: "/mes",
    target: "Tu socio digital, no solo tu proveedor",
    highlighted: false,
    features: [
      "Todo lo de CARE Plus, más:",
      "Cambios ilimitados de contenido — sin contar, sin límites, cuando los necesites",
      "Soporte directo por WhatsApp con respuesta en menos de 4 horas hábiles",
      "Una mejora de diseño por trimestre: sección nueva, rediseño de bloque, lo que más le ayude a tu negocio",
      "Recomendaciones proactivas: te decimos qué actualizar antes de que afecte tus resultados",
    ],
